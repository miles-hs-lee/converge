...
const enUS: Dict = {
  ...
  "onboarding.heroTitle": "One workspace for multiple M365 accounts",
  "onboarding.heroDesc":
    "Converge connects calendars and people across multiple tenants. Add accounts to unify schedules and org info, then move faster with search and quick actions.",
  "onboarding.coreLabel": "Core feature {index}",
  "onboarding.core1Title": "Unified calendar",
  "onboarding.core1Desc": "Multiple tenant schedules in one weekly/monthly view.",
  "onboarding.core2Title": "People search",
  "onboarding.core2Desc": "Search by name/department/tenant and jump to mail, Teams, or meeting creation.",
  "onboarding.core3Title": "Account management",
  "onboarding.core3Desc": "Connect additional accounts and manage connection status in Settings.",
  "onboarding.howTitle": "How it works",
  "onboarding.step1Title": "Sign in",
  "onboarding.step1Desc": "Sign in with Supabase Auth or Microsoft.",
  "onboarding.step2Title": "Connect accounts",
  "onboarding.step2Desc": "Connect additional tenant accounts in Settings.",
  "onboarding.step3Title": "Use calendar and people",
  "onboarding.step3Desc": "View unified schedules, search people, and use quick actions.",
  ...
  "onboarding.screen.calendarDesc": "Unified view across tenants with search, week/month navigation, and details.",
  "onboarding.screen.peopleTitle": "People search",
  "onboarding.screen.peopleDesc": "Open a profile popup with mail, Teams chat, and meeting actions.",
  "onboarding.screen.settingsTitle": "Settings",
  "onboarding.screen.settingsDesc": "Check connections, add accounts, and sign out.",
...
const koKR: Dict = {
  ...
  "onboarding.heroTitle": "여러 M365 계정을 하나의 워크스페이스로",
  "onboarding.heroDesc":
    "Converge는 여러 테넌트에 흩어진 캘린더와 직원 정보를 한 번에 연결합니다. 계정을 추가하면 일정과 조직 정보를 통합해서 보여주고, 검색과 빠른 액션으로 업무 전환 시간을 줄여줍니다.",
  "onboarding.coreLabel": "핵심 기능 {index}",
  "onboarding.core1Title": "통합 캘린더",
  "onboarding.core1Desc": "여러 테넌트 일정이 주간/월간으로 한 화면에 모입니다.",
  "onboarding.core2Title": "직원 검색",
  "onboarding.core2Desc": "이름/부서/테넌트로 검색하고 즉시 메일, Teams, 일정 생성으로 연결합니다.",
  "onboarding.core3Title": "계정 관리",
  "onboarding.core3Desc": "설정에서 추가 계정을 연결하고 연결 상태를 관리할 수 있습니다.",
  "onboarding.howTitle": "처음 시작은 이렇게",
  "onboarding.step1Title": "메인 계정 로그인",
  "onboarding.step1Desc": "Supabase 인증 또는 Microsoft 계정으로 로그인합니다.",
  "onboarding.step2Title": "추가 계정 연결",
  "onboarding.step2Desc": "설정에서 다른 테넌트 M365 계정을 연결합니다.",
  "onboarding.step3Title": "캘린더/조직도 활용",
  "onboarding.step3Desc": "통합 일정 확인, 직원 검색, 빠른 액션까지 한 번에 수행합니다.",
  ...
  "onboarding.screen.calendarDesc": "테넌트별 일정을 하나의 캘린더에 모아 검색, 주간/월간 탐색, 상세 확인이 가능합니다.",
  "onboarding.screen.peopleTitle": "조직도/직원 검색",
  "onboarding.screen.peopleDesc": "직원을 검색하고 상세 팝업에서 메일, Teams 채팅, 일정 생성 액션으로 바로 이동합니다.",
  "onboarding.screen.settingsTitle": "설정/계정 연결 관리",
  "onboarding.screen.settingsDesc": "연결 계정 상태를 확인하고 추가 연결 또는 로그아웃을 관리할 수 있습니다.",
...
const jaJP: Dict = {
  ...
  "onboarding.heroTitle": "複数の M365 アカウントを 1 つのワークスペースへ",
  "onboarding.heroDesc":
    "Converge は複数テナントに分散したカレンダーと社員情報をまとめて接続します。アカウントを追加して予定/組織情報を統合し、検索とクイックアクションで切り替え時間を短縮します。",
  "onboarding.coreLabel": "主要機能 {index}",
  "onboarding.core1Title": "統合カレンダー",
  "onboarding.core1Desc": "複数テナントの予定を週/月で 1 画面に集約。",
  "onboarding.core2Title": "社員検索",
  "onboarding.core2Desc": "名前/部署/テナントで検索し、メール/Teams/会議作成へ即移動。",
  "onboarding.core3Title": "アカウント管理",
  "onboarding.core3Desc": "設定で追加アカウントの接続と状態管理が可能。",
  "onboarding.howTitle": "はじめ方",
  "onboarding.step1Title": "ログイン",
  "onboarding.step1Desc": "Supabase 認証または Microsoft でログインします。",
  "onboarding.step2Title": "追加アカウント接続",
  "onboarding.step2Desc": "設定で別テナントの M365 アカウントを接続します。",
  "onboarding.step3Title": "活用",
  "onboarding.step3Desc": "統合予定の確認、社員検索、クイックアクションまで一括で。",
  ...
  "onboarding.screen.calendarDesc": "テナント横断で検索、週/月移動、詳細確認ができます。",
  "onboarding.screen.peopleTitle": "組織/社員検索",
  "onboarding.screen.peopleDesc": "プロフィールポップアップからメール/Teams/会議作成へ。",
  "onboarding.screen.settingsTitle": "設定",
  "onboarding.screen.settingsDesc": "接続状態の確認、追加接続、ログアウトを管理します。",
